...
python crp_pipeline_runner.py -i 'input_files/Epat34/inp.csv' -c '7'
...
python crp_pipeline_runner.py -i 'input_files/Spat41/inp.csv' -c '7'
echo done with Spat41

python crp_pipeline_runner.py -i 'input_files/Spat42/inp.csv' -c '7'
echo done with Spat42

python crp_pipeline_runner.py -i 'input_files/Spat44/inp.csv' -c '7'
echo done with Spat44

python crp_pipeline_runner.py -i 'input_files/Spat48/inp.csv' -c '7'
echo done with Spat48


python crp_pipeline_runner.py -i 'input_files/Spat49/inp.csv' -c '7'
echo done with Spat49

python crp_pipeline_runner.py -i 'input_files/Spat50/inp.csv' -c '7'
...
python crp_pipeline_runner.py -i 'input_files/Spat53/inp.csv' -c '7'
echo done with Spat53


python crp_pipeline_runner.py -i 'input_files/Spat55/inp.csv' -c '7'
echo done with Spat55

python crp_pipeline_runner.py -i 'input_files/Spat56/inp.csv' -c '7'
